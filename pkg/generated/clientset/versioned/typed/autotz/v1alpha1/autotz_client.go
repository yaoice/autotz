...
import (
	...
	"github.com/yaoice/autotz/pkg/generated/clientset/versioned/scheme"
	serializer "k8s.io/apimachinery/pkg/runtime/serializer"
	rest "k8s.io/client-go/rest"
)

type AutotzV1alpha1Interface interface {
...
func NewForConfig(c *rest.Config) (*AutotzV1alpha1Client, error) {
	...
	return &AutotzV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new AutotzV1alpha1Client for the given config and
